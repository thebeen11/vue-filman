<template>
   <div class="section__padding">
    <movie-card :items="upcoming" :title="title" :loading="loading" @loadMore="loadMore"/>
  </div>
</template>
...
export default {
  ...
  methods:{
    async getData(){
      ...
      const res = await this.$store.dispatch('get/get/upcoming', params)
